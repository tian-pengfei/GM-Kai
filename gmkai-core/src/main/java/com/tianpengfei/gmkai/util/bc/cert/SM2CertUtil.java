...
import cn.com.agree.ab.a5.runtime.gmssl.util.bc.BCECUtil;
import cn.com.agree.ab.a5.runtime.gmssl.util.bc.SM2Util;
...
public class SM2CertUtil {
    ...
    public static CertPath getCertificateChainFromPEM(String certChainPEM) throws CertificateException,
            NoSuchProviderException {
        CertificateFactory cf = CertificateFactory.getInstance("X.509", BouncyCastleProvider.PROVIDER_NAME);
        ByteArrayInputStream bais = new ByteArrayInputStream(certChainPEM.getBytes(StandardCharsets.UTF_8));
        return cf.generateCertPath(bais, "PEM");
    }
